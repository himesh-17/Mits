...
export default function FormFooter() {
    ...
    const handleNext = () => {
        ...
        const requiredFields = [
            formData.fullName, formData.dob, formData.fatherName, formData.gender,
            formData.email, formData.mobile, formData.fatherMobile, formData.motherMobile, formData.address
        ];
