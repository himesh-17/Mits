            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full h-10 px-3 rounded-md border border-[#E5E7EB] text-sm text-[#0F172A] focus:outline-none focus:border-[#0EA5E9] focus:ring-1 focus:ring-[#0EA5E9]"
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="w-full h-10 px-3 rounded-md border border-[#E5E7EB] text-sm text-[#0F172A] bg-white focus:outline-none focus:border-[#0EA5E9] focus:ring-1 focus:ring-[#0EA5E9] appearance-none"
                    >
