...
export default function AccountOfficePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] px-4 py-10 text-white sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-3xl flex-col items-start gap-6 rounded-4xl border border-white/10 bg-white/8 p-6 backdrop-blur-xl sm:p-8">
        ...
        <h1 className="text-3xl font-semibold sm:text-4xl">Portal shell ready for finance workflows.</h1>
        <p className="max-w-2xl text-sm leading-7 text-white/70 sm:text-base">
          This route is now valid from the login portal selector, so the navigation is complete even before the account dashboard is fully built.
        </p>
