      ...
      <div className="flex flex-col gap-3 lg:h-16.25 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 pb-1">
          <button
            ...
            className="admin-btn h-9.75 w-33.75 bg-white border border-black/10 rounded-md inline-flex items-center justify-center gap-2 text-[14px] text-[#0F1724]"
          >
          ...
          <button
            ...
            className="admin-btn h-9.75 w-37.5 bg-white border border-black/10 rounded-md inline-flex items-center justify-center gap-2 text-[14px] font-medium text-[#0F1724]"
          >
          ...
          <table className="w-full min-w-450 border-collapse text-left">
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr
                  key={row.id}
                  className="admin-row-enter h-17.5 text-[14px] text-[#0F1724]"
                ...
                >
                  ...
                  <td className="px-6 border-b border-black/10">
                    <span
                      className={`inline-flex items-center h-5.75 px-2.5 rounded text-[12px] font-semibold ${statusClass(row.finalStatus)}`}
                    >
                      {row.finalStatus}
                    </span>
                  </td>
              ...
              {!isLoading && rows.length === 0 && (
                <tr>
                  <td colSpan={19} className="px-6 py-10 text-center text-[14px] text-[#64748B]">
